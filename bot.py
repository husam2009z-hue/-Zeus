...
try:
    API_ID = int(os.environ.get("API_ID", 37145655))
    API_HASH = os.environ.get("API_HASH", "4cbcca44c0b8435cb07f1ca10a331c63")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8821425561:AAGGkmQLGAFI6hEbQERfYI4uQfF0g32SoDw")
    OWNER_ID = int(os.environ.get("OWNER_ID", 8388151950))
except:
    API_ID = 37145655
